...
> Source: `projects/little-milestones/pipeline-state.json` · rendered 2026-07-29 19:15 UTC
...
**Pipeline status**: `RED` — 6 finding(s)
...
| 6 | Architecture | `warn` | `approved` | — | — | Mobile architecture landed in SECURITY_KB §9 / UX_KB §13, never in ARCHITECTURE_KB. Closed retrospectively 2026-07-28. |
| 7 | Code | `done` | `approved` | — | — |  |
| 8 | Test | `warn` | `approved` | — | — | Rendered-UI contract live with no native backend — Playwright cannot load an RN tree. Six defects structurally uncatchable. |
| 9 | Verify | `skipped` | `skipped_recorded` | `gate_did_not_exist` | — | Gate added 2026-07-28 — coverage gap, not a template exclusion |
| 10 | Review | `skipped` | `not_asked` | `skipped_without_exception` | — | Skipped by the orchestrator. No human exception was requested. |
| 11 | Deploy | `done` | `approved` | — | — |  |

## Loop-backs

8 total, **7 originated by the human**.

| Date | From | To | Reason | Origin | Resolved |
|------|------|----|--------|--------|----------|
| 2026-07-26 | 8 | 7 | Logout over bearer left a live 30-day server session | gate | ✅ |
| 2026-07-27 | 11 | 7 | Avatar built, never rendered | human | ✅ |
| 2026-07-27 | 11 | 7 | Journey photos never rendered | human | ✅ |
| 2026-07-27 | 11 | 7 | Lightbox + gallery never mounted | human | ✅ |
| 2026-07-27 | 11 | 7 | Chat-history sheet never mounted | human | ✅ |
| 2026-07-27 | 11 | 7 | Prompt chips rendered as ovals | human | ✅ |
| 2026-07-28 | 11 | 7 | Dead band above composer | human | ✅ |
| 2026-07-28 | 11 | 7 | First prompt chip age-blind across all 10 buckets | human | ✅ |
