...
| little-milestones | genai-chatbot | Increment 2 deployed (dev, local); Increment 3 next | local | 2026-07-11 | F1-F8(content) shipped & fully gated; F8(delivery)+F9+F10 remain in Increment 3 |
