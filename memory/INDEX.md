...
| conclave-finance-studio | custom (FastAPI, server-rendered) | gate 9 Verification (gates 1-8 done; gate 8 CLOSED at 2,988 scenarios) | dev, local | 2026-08-03 | MVP1 built, redesigned and runnable at http://127.0.0.1:8030/. 9 suites, 6 orderings, 0 failures. UX redesign approved by the human and implemented: Work/Govern/Evidence IA as a checked artefact, 8 object-graph edges, Approvals as its own screen, Conclave identity carried from conclave-marketing. 5 gate-8 loop-backs, none a failing test. |
