...
| conclave-finance-studio | pending (plan-agent rec) | gate 1 Intake | dev, local | 2026-07-30 | Multi-agent close system for finance accountants. 3 surfaces, write-back with per-action approval. MVP slice + harm analysis delegated to SMEs |
