...
| conclave-finance-studio | custom (FastAPI, server-rendered) | gate 7 Code — pass 17, approved UX redesign (gates 1-8 done, 8 closed at 2,774 tests) | dev, local | 2026-08-03 | MVP1 built and runnable: `CONCLAVE_ENV=pilot .venv/bin/python backend/pilot.py`. 2,774 scenarios, 8 suites, order-independent. 255/262 criteria verified at last audit; 5 declared NOT VERIFIED (dependency-bound). Human found the UI unnavigable on 2026-08-02; redesign approved and in build. |
