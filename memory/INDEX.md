...
| conclave-finance-studio | custom (FastAPI, server-rendered) | gate 8 CLOSED at 3,037 scenarios; gate 9 Verification next | dev, local | 2026-08-04 | MVP1 built, redesigned and runnable at http://127.0.0.1:8030/. 3,037 scenarios, 10 suites, 6 orderings, 0 failures. Spec 267 issued / 265 live / 2 retired. functional-design-agent ruled a split element set is not a relocation: AC-F41-13 retired, AC-F41-22/-23/-24 + AC-F5-08 issued and all met. Retained view now DERIVED from the screen, not assembled beside it. |
