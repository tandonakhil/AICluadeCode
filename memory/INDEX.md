...
| little-milestones | genai-chatbot | deployed (dev, local) -- Increments 5-7 shipped (F13/F12/F17) | local | 2026-07-13 | F1-F10 MVP + F14/F15/F16 avatars/lightbox/gallery + chat history/Ask (F13) + hardened auth/MFA (F12) + Google Photos import (F17) |
| conclave-marketing | custom (marketing site, FastAPI) | Intake | local | 2026-07-17 | Conclave's own marketing website as a governed project; seeded from admin/deliverables/microsite.html v5; multi-page THRED-inspired design |
