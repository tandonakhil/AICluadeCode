...
**Last regenerated**: 2026-08-05  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained
...
| [conclave-finance-studio](#conclave-finance-studio) | custom (FastAPI, server-rendered) | Gate 10 — Review: awaiting the human on claim prohibition 6 | dev, local | 10 of 11 | [live](http://127.0.0.1:8030/) | 2026-08-05 |
