...
**Last regenerated**: 2026-08-03  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained
...
| [conclave-finance-studio](#conclave-finance-studio) | custom (FastAPI, server-rendered) | Gate 8 — Test (re-run after pass 19) | dev, local | 7 of 11 | [live](http://127.0.0.1:8030/) | 2026-08-03 |
