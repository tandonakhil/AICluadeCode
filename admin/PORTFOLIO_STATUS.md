...
**Last regenerated**: 2026-08-04  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained  ·  table generated from `pipeline-state.json` by `admin/regen-portfolio-glance.py`, not hand-maintained
...
| [conclave-finance-studio](#conclave-finance-studio) | custom (FastAPI, server-rendered) | Gate 7 — pass 23 (advisory cleanup), then Gate 9 Verification | dev, local | 8 of 11 | [live](http://127.0.0.1:8030/) | 2026-08-04 |
